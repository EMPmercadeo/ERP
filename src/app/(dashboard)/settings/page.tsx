...
export default async function SettingsPage() {
    ...
    const companyData = {
        ...
        yappyEnabled: empresa.yappyEnabled,
        yappyMerchantId: empresa.yappyMerchantId || '',
        yappyDomain: empresa.yappyDomain || '',
        yappyAmbiente: empresa.yappyAmbiente,
        hasYappySecretKey: !!empresa.yappySecretKey,
