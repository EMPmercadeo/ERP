                                    ...
                                    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                                        <div className="flex items-center gap-3">
                                            ...
                                            {estadoConexion === 'desconectado' && (
                                                <Badge variant="secondary" className="bg-secondary text-white hover:bg-secondary">
                                    ...
                                    {company.planType === 'free' || company.planType === 'emprendedor' ? (
                                        ...
                                        <div className="grid gap-8 lg:grid-cols-2">
                                            ...
                                            <div className="space-y-4 border-r pr-0 lg:pr-8 border-border">
                                                <h4 className="text-sm font-bold text-foreground">Conectar Nuevo POS</h4>
                                                        ...
                                                        <div className="flex flex-wrap gap-4 text-xs">
                                                            <label className="flex items-center gap-1.5 font-medium cursor-pointer">
                                                                <input 
                                                                    ...
                                                                    className="rounded border-border text-brand-1 focus:ring-brand-1 mr-1"
                                                                />
                                                                Productos
                                                            </label>
                                                            <label className="flex items-center gap-1.5 font-medium cursor-pointer">
                                            ...
                                            <div className="space-y-6">
                                                <h4 className="text-sm font-bold text-foreground">POS Conectados</h4>
                                                ...
                                                {posIntegrations.length === 0 ? (
                                                    ...
                                                    <div className="space-y-6">
                                                        {posIntegrations.map((integration) => (
                                                            <div key={integration.id} className="border rounded-lg p-4 bg-muted/50 space-y-4">
                                                                <div className="flex justify-between items-center">
                                                                    <div>
                                                                        <div className="font-bold text-xs text-foreground">{integration.providerName}</div>
                                                                            ...
                                                                            {integration.syncLogs?.map((log) => (
                                                                                <div key={log.id} className="text-[10px] flex justify-between gap-2 p-1.5 bg-white rounded border">
                                                                                    <div className="min-w-0 flex-1">
                                                                                        ...
                                                                                        <span className="text-muted-foreground truncate inline-block w-full max-w-[200px] align-bottom ml-1">{log.message}</span>
                                                                                    </div>
                    ...
                    <div className="w-full max-w-md bg-card rounded-xl border border-border shadow-2xl p-6 relative font-sans">
                        ...
                        {paymentStep === 'details' && (
                            <div className="space-y-6">
                                <div className="text-center">
                                    <h3 className="text-xl font-bold text-foreground">Suscripción al Plan</h3>
                                    <p className="text-xs text-muted-foreground mt-1">Completa el pago recurrente para activar tu plan fiscal de inmediato.</p>
                                </div>

                                <div className="bg-muted border rounded-lg p-4 space-y-2 text-sm text-foreground">
                        ...
                        {paymentStep === 'simulating' && (
                            <div className="text-center py-12 space-y-6">
                                ...
                                <div className="space-y-2">
                                    <h4 className="font-bold text-foreground">Conectando con PayPal...</h4>
                        ...
                        {paymentStep === 'success' && (
                            <div className="text-center py-8 space-y-6">
                                ...
                                <div className="space-y-2">
                                    <h4 className="text-xl font-bold text-foreground">¡Suscripción Activada!</h4>
                                    <p className="text-xs text-muted-foreground">
                        ...
                        <div className="space-y-5">
                            <div className="flex items-start gap-4">
                                ...
                                <div className="space-y-1">
                                    <h3 className="text-lg font-bold text-foreground">¿Cancelar tu suscripción?</h3>
                                    <p className="text-xs text-muted-foreground">
