            ...
            <ContentContainer className="space-y-4">
                ...
                <div className="grid gap-4 md:grid-cols-3">
                    ...
                    <Link href="/invoices?status=pendiente" className="block">
                        <Card className="cursor-pointer transition-colors hover:bg-accent border-border group h-full">
                            <CardContent className="flex items-center gap-4 pt-6">
                                <div className="rounded-lg bg-success/10 p-3 group-hover:bg-success group-hover:text-white transition-colors text-success">
                    ...
                    <Link href="/reports" className="block">
                        <Card className="cursor-pointer transition-colors hover:bg-accent border-border group h-full">
                            <CardContent className="flex items-center gap-4 pt-6">
                                <div className="rounded-lg bg-info/10 p-3 group-hover:bg-info group-hover:text-white transition-colors text-info">
