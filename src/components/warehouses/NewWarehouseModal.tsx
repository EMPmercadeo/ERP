...
import { createBodega } from '@/lib/actions/bodegas';
...
export function NewWarehouseModal({ sucursales }: { sucursales: SucursalOption[] }) {
    ...
    async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
        ...
        try {
            const res = await createBodega(null, formData);
        ...
        <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent className="sm:max-w-[500px]">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Crea una bodega asociada a una sucursal para gestionar su inventario.
                    </DialogDescription>
                </DialogHeader>
                <form onSubmit={handleSubmit} className="space-y-4 py-2">
                    ...
                    <div className="grid grid-cols-3 gap-3">
                        <div className="col-span-1">
                            ...
                            <Input id="codigo" name="codigo" required placeholder="Ej. 001" maxLength={10} />
                        </div>
                        <div className="col-span-2">
                            <Label htmlFor="nombre">Nombre de la Bodega *</Label>
                            <Input id="nombre" name="nombre" required placeholder="Ej. Bodega Central" />
                        </div>
                    </div>
